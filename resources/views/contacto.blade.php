...
@section('content')
    ...
    <!--=====================================-->
    <!-- start inner-banner -->
    <section class="inner-page-banner inner-banner-6" data-bg-image="{{ URL::asset('image/banner/inner-banner6.jpg')}}">
    <div class="container">
    ...
    <div class="container">
        ...
        <div class="col-lg-4 wow fadeInLeft animated" data-wow-delay="0.7s" data-wow-duration="1s">
            ...
            <div class="address-box color-three">
                ...
                <ul class="address-details">
                <li>(+48) 564-3342-1223</li>
                <li>(+48) 564-3342-1225</li>
                </ul>
            </div>
            </div>
        </div>
