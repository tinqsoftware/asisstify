                ...
                <div class="col-lg-6 wow fadeInLeft animated" data-wow-delay="0.5s" data-wow-duration="1s">
                    <div class="contact-box-layout2">
                        <div class="contact-form">
                            <h2 class="title">Crear un evento</h2>
                            
                            <form method="POST" action="/evento/crear">
                                @csrf
                                <div class="row mb-3">
                                    ...
                                    <div class="col-12 form-group mb-0">
                                        <button type="submit" class="btn-fill style-one">Crear evento</button>
                                        <a href="evento/inicio" type="submit" class="btn-fill style-six">Cancelar</a>
                                    </div>
