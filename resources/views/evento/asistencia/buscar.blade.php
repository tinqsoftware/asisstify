                ...
                <div class="col-lg-12 wow fadeInLeft animated" data-wow-delay="0.5s" data-wow-duration="1s">
                    <div class="contact-box-layout2">
                        <div class="contact-form">
                            <h2 class="title"><b>Buscar mis asistencias</b></h2>
                            <h6> Ingresa tu datos para mostrarte todas <b>las asistencias y constancias</b> asociados </h6>
                            <div class="schedule-inner-wrap-layout2">
                                <ul class="tab-nav nav mb-4" role="tablist">
                                    <li class="menu-item" role="presentation">
                                        <a class="menu-link active" id="menu-1-tab" data-bs-toggle="tab" href="#menu-1" role="tab" aria-controls="menu-1" aria-selected="false">Buscar por DNI</a>
                                    </li>
                                    <li class="menu-item" role="presentation">
                                        <a class="menu-link" id="menu-2-tab" data-bs-toggle="tab" href="#menu-2" role="tab" aria-controls="menu-2" aria-selected="false">Buscar por correo</a>
                                    </li>
                                </ul>
                                <div class="tab-content">
                                    <div class="tab-pane tab-item animated fade show active" id="menu-1" role="tabpanel" aria-labelledby="menu-1-tab">
                                        <form method="POST" action="/asistencia">
                                            @csrf
                                            <div class="row mb-3">
                                                <input id="tipo_busqueda" type="text" name="tipo_busqueda" required style="display:none;" value="dni">
                                                ...
                                                <div class="col-12 form-group mb-0">
                                                    <button type="submit" class="btn-fill style-one">Buscar nro docuemento</button>
                                    ...
                                    <div class="tab-pane tab-item animated fade" id="menu-2" role="tabpanel" aria-labelledby="menu-2-tab">
                                        <form method="POST" action="/asistencia">
                                            @csrf
                                            <div class="row mb-3">
                                                <input id="tipo_busqueda" type="text" name="tipo_busqueda" required style="display:none;" value="correo">
                                                <div class="col-md-12 form-group">
                                                ...
                                                <div class="col-12 form-group mb-0">
                                                    <button type="submit" class="btn-fill style-one">Buscar correo</button>
                                                    <a href="/evento" type="submit" class="btn-fill style-six">Cancelar</a>
                                                </div>
