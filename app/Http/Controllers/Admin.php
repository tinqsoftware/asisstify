...
use App\Models\CertificadosPonentes;
...
class Admin extends Controller{
    ...
    public function perfiles_nuevo(){
        return view('admin.perfiles_nuevo');
    }

    public function perfiles_editar(){
        return view('admin.perfiles_editar');
    }
    ...
    public function usuarios_editar(){
        return view('admin.usuarios_editar');
    }


    //Programación
    public function programacion(){
        return view('admin.programacion');
    }

    public function programacion_editar(){
        return view('admin.programacion_editar');
    }
    ...
    public function certificado_PDF($tipo, $id){
        ...
        if($tipo == 1){
            $capa = CertificadosPonentes::find($id);
            $fecha_ =Carbon::parse($capa->fecha_capa);
            // == ENVIANDO certificado a ponente
            $nombre_ponente = trim(mb_strtoupper($capa->ponente));
            $fecha_ =Carbon::parse($capa->fecha_capa);
